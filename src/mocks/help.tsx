...
export const detail = [
  {
    ...
    content: (
      <>
        ...
        <p>
          Ratione earum minus quia consectetur debitis magnam. Ex nemo maiores
          reiciendis distinctio. Cupiditate nihil doloribus repellat voluptatem.
        </p>
        <p>
          Et id possimus harum ipsa eum odit labore. Eligendi repellat impedit
          eaque corporis dolor ipsam vero. Vitae beatae aperiam consequatur
          consequatur praesentium minus sequi magni.
        </p>
        <p>
          Et neque dolor velit aliquid earum reiciendis sequi harum. Laudantium
          et doloremque deleniti quaerat. Dolorem molestias doloribus. Non non
          laboriosam ut assumenda vel aut sequi.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Et neque dolor velit aliquid earum reiciendis sequi harum. Laudantium
          et doloremque deleniti quaerat.
        </p>
        <ul>
